...
const VideoPlayer = () => {
  ...
  if (loading) {
    return <div className="loading-screen">Loading Video....</div>;
  }
  if (error || !video) {
    return <div className="error-message">{error || "Video Not Found"}</div>;
  }
  return (
    <main className="video-page">
      ...
      <div className="video-details">
        <div className="channel-info">
          <img
            src={video.channel?.channelAvatar || "https://i.pravatar.cc/100"}
            alt=""
          />
        </div>
        <div>
